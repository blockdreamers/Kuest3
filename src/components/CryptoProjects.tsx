...
import { formatPriceKRW, formatMarketCapKRW, formatVolumeKRW } from '../lib/utils/formatKRW';
          ...
          <Link key={coin.id} to={`/coin/${coin.id}`} className={`${styles.cryptoCard} ${styles.cryptoCardHover}`}>
            <div className={styles.cryptoCardInner}>
              ...
              <div className="text-white mb-[0.3rem]">
                <p className={styles.cryptoTextBase}>
                  {formatPriceKRW(coin.price, exchangeRate)}
                </p>
                <div
              ...
              <div className={`grid grid-cols-2 gap-2 text-xs mt-[0.2rem] ${styles.cryptoStatsGrid}`}>
                <div>
                  ...
                  <p className="cryptoStatValue">{formatMarketCapKRW(coin.marketCap, exchangeRate)}</p>
                </div>
                <div>
