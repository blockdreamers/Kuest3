      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-5 gap-10 items-start">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/login" className="footer-link">회원가입</Link></li>
            <li><Link to="/quest/1" className="footer-link">퀘스트 수행하기</Link></li>
            <li><Link to="/points" className="footer-link">포인트 모으기</Link></li>
            <li><Link to="/listing" className="footer-link">리스팅 신청하기</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/about" className="footer-link">회사 소개</Link></li>
            <li><Link to="/business" className="footer-link">사업 제안</Link></li>
            <li><a href="mailto:contact@kuest3.com" className="footer-link">제휴 문의</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/user-agreements" className="hover:underline">이용약관</Link></li>
            <li><Link to="/privacy-policies" className="hover:underline">개인정보처리방침</Link></li>
          </ul>
        </div>
