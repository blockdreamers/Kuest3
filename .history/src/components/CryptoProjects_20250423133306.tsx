    ...
    <div className="mb-12 font-['Montserrat','Pretendard']">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-6">
        {displayCoins.map((coin) => (
          ...
          >
            <div className="coin-box-inner"></div>
            <div className="relative px-2 pt-2 pb-1">
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div className="leading-tight">
                    <h2 className="text-base font-medium">{coin.name}</h2>
              ...
              <div className="text-white mb-1">
                ...
                <div className={`flex items-center text-sm ${coin.priceChange >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  {coin.priceChange >= 0 ? (
