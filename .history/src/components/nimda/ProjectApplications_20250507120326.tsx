...
console.log("🔥 ProjectApplications 컴포넌트가 마운트되었습니다");
...
const ProjectApplications = () => {
  ...
  useEffect(() => {
    ...
    if (applications.length === 0) {
      console.warn("⚠️ applications 배열이 비어있음");
    } else {
      console.info("✅ applications 정상:", applications);
    }
  }, [applications]);

  console.log("📦 최종 렌더링될 applications 배열:", applications);
