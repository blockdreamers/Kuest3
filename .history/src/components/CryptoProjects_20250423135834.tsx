          ...
          <Link key={coin.id} to={`/coin/${coin.id}`} className="coin-box group">
            <div className="coin-box-inner">
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div className="leading-tight">
                    <h2 className="coin-name">{coin.name}</h23
              ...
              <div className="text-white mb-1">
                <p className="text-base font-semibold">${coin.price.toLocaleString()}</p>
                <div className={`flex items-center text-sm ${coin.priceChange >= 0 ? 'text-green-400' : 'text-red-400'} mb-2`}>
                  {coin.priceChange >= 0 ? (
              ...
              <div className="grid grid-cols-2 gap-2 text-xs text-white mt-1">
                <div>
