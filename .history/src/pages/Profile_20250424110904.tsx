...
function Profile() {
  ...
  useEffect(() => {
    ...
    const addressFromLegacyField = privyUser?.wallet?.walletAddress;
    const addressFromWalletsArray = privyUser?.wallets?.[0]?.address;

    if (addressFromLegacyField) {
      console.log('✅ [Privy] wallet.walletAddress 확보:', addressFromLegacyField);
      setWalletAddress(addressFromLegacyField);
    } else if (addressFromWalletsArray) {
      console.log('✅ [Privy] wallets[0].address 확보:', addressFromWalletsArray);
      setWalletAddress(addressFromWalletsArray);
    } else {
