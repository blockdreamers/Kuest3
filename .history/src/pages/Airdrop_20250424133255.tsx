...
const AIRDROP_CONTRACT_ADDRESS = '0x83f954578bc8B4732E1957a439dB1Cb60A47Fc5A'; // ✔️ 수정된 Kuest Airdrop 계약 주소
...
const Airdrop = () => {
  ...
  useEffect(() => {
    if (privyReady && privyUser?.wallet?.address) {
      ...
      console.log('🔗 Privy 지갑 주소:', address);
  ...
  const fetchAirdropInfo = async () => {
    try {
      ...
      console.log('📦 조회된 수량:', amountFormatted, 'KST');
