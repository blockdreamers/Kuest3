...
const Login = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-gray-50 font-['Pretendard','Montserrat',sans-serif] px-4">
      {/* 상단 로고 + 텍스트 */}
      ...
      {/* 회원가입 박스 */}
      <div className="w-full max-w-md bg-black text-white rounded-xl shadow-lg p-6 mb-6 text-center">
        <h2 className="text-xl font-semibold mb-4">회원가입</h2>
        <button
          onClick={() => handleGoogleSignIn(true)}
          disabled={isProcessing}
          className={`w-full flex items-center justify-center px-4 py-3 rounded-lg text-sm font-semibold bg-black text-white hover:bg-[#C7EB3E] hover:text-black active:scale-[0.97] transition-all duration-200 ${
      ...
      {/* 로그인 박스 */}
      <div className="w-full max-w-md bg-black text-white rounded-xl shadow-lg p-6 text-center">
