...
const AIRDROP_CONTRACT_ADDRESS = '0x83f954578bc8B4732E1957a439dB1Cb60A47Fc5A'; // Replace with your contract
...
const Airdrop = () => {
  ...
  const fetchAirdropInfo = async (address: string) => {
    try {
      ...
      console.log('🎯 나의 에어드랍 수량:', amountFormatted);
  ...
  if (!user || !privyReady) return null;
