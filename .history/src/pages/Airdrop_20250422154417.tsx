...
const AIRDROP_CONTRACT_ADDRESS = '0x85b1a621e4c46a9c59e5c1f2ca7245244ad3fb8';
...
const Airdrop = () => {
  ...
  const claimedAmount = 324_580_000; // 이건 실제 contract에서 계산하려면 totalSupply - 컨트랙트 balance 등 필요
  ...
  const fetchAirdropInfo = async () => {
    ...
    const amount = await contract.airdropAmount(user.wallet.address);
    const claimed = await contract.claimed(user.wallet.address);
