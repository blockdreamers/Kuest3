...
const Airdrop = () => {
  ...
  const getInfuraProvider = () => {
    if (!INFURA_SEPOLIA_URL) {
      console.error('❌ Infura URL이 설정되지 않음');
      return null;
    }
    console.log('🌐 Infura Provider 생성');
