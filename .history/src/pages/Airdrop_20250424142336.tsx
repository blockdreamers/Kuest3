...
const Airdrop = () => {
  ...
  const getInfuraProvider = (): ethers.providers.JsonRpcProvider => {
    console.log('🛰️ [Infura] Provider 연결 시도중:', INFURA_SEPOLIA_URL);
