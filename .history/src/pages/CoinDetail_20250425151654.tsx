          ...
          <div className={styles['coin-detail-stats-block']}>
            <div className={styles['coin-detail-stats-col']}>
              ...
              <div>
                ...
                <p className={styles['coin-detail-value']}>{coin.circulating_supply}M {coin.symbol}</p>
              </div>
            </div>
            ...
            <div className={styles['coin-detail-stats-col']}>
              ...
              <div>
                ...
                <p className={styles['coin-detail-value']}>{coin.volume_market_cap}%</p>
              </div>
              <div>
                <p className={styles['coin-detail-label']}>최대 발행량</p>
                <p className={styles['coin-detail-value']}>{coin.max_supply}M {coin.symbol}</p>
              </div>
            </div>
          </div>
