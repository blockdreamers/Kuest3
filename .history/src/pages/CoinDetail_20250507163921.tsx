        ...
        <div className={styles['coin-detail-card']}>
          ...
          <div className={styles['coin-detail-right-box']}>
            <div className={styles['coin-detail-tweet-head']}>
              <Vote className="text-yellow-400 w-5 h-5" />
              <h2 className="text-lg font-semibold">투표 현황</h2>
            </div>

            <p className="text-sm text-gray-300 mb-2">
              {coin.name_ko || coin.name} 프로젝트는 #시즌1, #시즌2에 참여하여 총 12,345표를 획득하였으며 누적 투표수 기준 3위입니다.
            </p>

            <select className="w-full mb-3 px-3 py-2 bg-[#242424] border border-gray-700 rounded-md text-sm text-white">
              <option value="1">시즌 1</option>
              <option value="2">시즌 2</option>
            </select>

            <div className="text-sm text-white space-y-1 mb-4">
              <p>누적 투표수: <span className="font-semibold text-[#C7EB3E]">4,321표</span></p>
              <p>나의 투표수: <span className="font-semibold text-[#C7EB3E]">10표</span></p>
              <p>이번 시즌 에어드랍 수량: <span className="font-semibold text-[#C7EB3E]">1,000 {coin.symbol}</span></p>
            </div>
